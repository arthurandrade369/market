...
class OrdersController
{
    ...
    public function newOrder(Orders $order)
    {
        $sql = "
        INSERT INTO
            orders(type, receipt, forecast, clients_id, buy_id)
        VALUES
            (:type, :receipt, :forecast, :clients_id, :buy_id)
        ";
        ...
        $pSql->bindValue('buy_id', $order->getBuyId());
    ...
    public function showAllOrders()
    {
        ...
        FROM 
            orders AS o
        INNER JOIN buy AS b ON o.buy_id = b.id
